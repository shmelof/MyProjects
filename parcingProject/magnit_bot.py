...
bot = Bot(token='5879944909:AAH2urwUhs_vfoir8hKRhOjQvJZUhWtAs64')
dp = Dispatcher(bot)
...
async def start(message: types.Message):
    ...
    await message.answer('Please, choose the City', reply_markup=keyboard)
